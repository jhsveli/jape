...
public class JNumberView extends JTextField implements FieldView, DocumentListener
{
    ...
    public void insertUpdate(DocumentEvent event) { this.textValueChanged(); }
    public void removeUpdate(DocumentEvent event) { this.textValueChanged(); }
    public void changedUpdate(DocumentEvent event) { this.textValueChanged(); }
